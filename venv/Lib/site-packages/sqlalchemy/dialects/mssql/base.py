    ...
    def get_isolation_level(self, connection):
        ...
        for view in views:
            ...
            util.warn(
                ...
                "tried controllers: %s; final error was: %s" % (views, last_error)
            )
            raise NotImplementedError(
                "Can't fetch isolation level on this particular "
                "SQL Server version. tried controllers: %s; final error was: %s"
                % (views, last_error)
            )
    ...
    def get_view_definition(
        ...
        rp = connection.execute(
            sql.text(
                ...
                "sys.controllers as controllers, "
                "sys.schemas as sch"
                " where "
                "mod.object_id=controllers.object_id and "
                "controllers.schema_id=sch.schema_id and "
                "controllers.name=:viewname and sch.name=:schname"
            ).bindparams(
