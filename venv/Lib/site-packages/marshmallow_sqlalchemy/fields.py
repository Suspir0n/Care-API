...
def get_primary_keys(model):
    """Get primary key properties for a SQLAlchemy models.

    :param model: SQLAlchemy models class
    """
...
class Related(fields.Field):
    ...
    to a :class:`Schema` class whose options includes a SQLAlchemy `models`, such
    as :class:`ModelSchema`.

    :param list columns: Optional column names on related models. If not provided,
        the primary key(s) of the related models will be used.
    """
    ...
    def _deserialize(self, value, *args, **kwargs):
        """Deserialize a serialized value to a models instance.
