...
class ModelConverter:
    """Class that converts a SQLAlchemy models into a dictionary of corresponding
    ...
    def fields_for_table(
        ...
        *,
        ...
        for column in table.columns:
            ...
            # self._get_key_for_column(...), rather than keys in source models
...
"""Generate a dict of field_name: `marshmallow.fields.Field` pairs for the given models.
Note: SynonymProperties are ignored. Use an explicit field if you want to include a synonym.

:param models: The SQLAlchemy models
...
:param type models: A SQLAlchemy mapped class.
